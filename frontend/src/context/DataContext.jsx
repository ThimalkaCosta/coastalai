...
function normaliseAnalysisData(analysisData) {
  ...
  return {
    ...
    hmmModel,
    xgbModel,
    // Nested models structure for pages that use data.models.rf / .hmm / .xgb
    models: { rf: rfModel, hmm: hmmModel, xgb: xgbModel },
    sarimaDiagnostics,
    sarimaForecasts,
...
export function DataProvider({ children }) {
  ...
  const emptyState = {
    summary: null, shoreline: [], timeSeries: [], processed: [], statisticalTests: [],

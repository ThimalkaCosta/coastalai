...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-2 sm:top-3 left-2 sm:left-3 right-2 sm:right-3 z-50">
      <div className="max-w-[1500px] mx-auto bg-white/95 backdrop-blur-xl rounded-xl sm:rounded-2xl shadow-[0_6px_20px_rgba(0,0,0,0.08),0_2px_6px_rgba(0,0,0,0.05),inset_0_1px_0_rgba(255,255,255,0.6)] border border-white/60">
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div
            ...
            className="lg:hidden bg-white border-t border-coastal-100 rounded-b-xl sm:rounded-b-2xl overflow-hidden"
          >

...
import { TrendingUp, Menu, X, Home } from 'lucide-react'

export default function LongTermHeader() {
            ...
            <div className="hidden lg:flex items-center gap-1 xl:gap-2">
              ...
              <Link
                ...
                className={`inline-flex items-center gap-2 px-3 xl:px-4 py-2 text-sm font-medium rounded-lg transition-all duration-200 whitespace-nowrap ${
                  isActive('/long-term-forecasting')
                    ? 'bg-blue-600 text-white shadow-md'
                    : 'text-coastal-600 hover:bg-blue-50 hover:text-coastal-900'
                }`}
              >
              ...
              <Link
                ...
                className="inline-flex items-center gap-2 px-3 xl:px-4 py-2 text-sm font-medium rounded-lg transition-all duration-200 whitespace-nowrap text-coastal-600 hover:bg-blue-50 hover:text-coastal-900"
              >
                <span>Short-Term Forecasting</span>
              </Link>
            </div>
            ...
            <div className="hidden lg:flex items-center gap-3">
              ...
              <div className="flex flex-col pl-3">
                <div className="flex items-center gap-2">
                  <TrendingUp className="w-5 xl:w-6 h-5 xl:h-6 text-blue-600" />
                  <span className="font-display font-bold text-lg xl:text-xl text-coastal-800">Long-Term</span>
                </div>
            ...
            >
              <div className="px-4 py-4 space-y-2">
                ...
                <Link
                  ...
                  className="flex items-center gap-3 px-4 py-3 rounded-xl transition-colors text-coastal-700 hover:bg-coastal-50"
                >
                  <span className="font-medium">Short-Term Forecasting</span>
                </Link>
                {/* Mobile Branding */}
                <div className="pt-4 mt-4 border-t border-coastal-100 flex items-center justify-center gap-2">
                  <TrendingUp className="w-5 h-5 text-blue-600" />
                  <span className="font-display font-bold text-coastal-800">Long-Term Forecasting</span>
                </div>
              </div>
            </motion.div>
          )}

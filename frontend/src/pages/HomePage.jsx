...
export default function HomePage() {
  ...
  return (
    <PageTransition>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <div className="page-badge bg-ocean-50 text-ocean-600 border-ocean-100 mb-6">
      ...
      {/* CTA Section */}
      <section className="py-12 sm:py-16 lg:py-20 bg-gradient-to-br from-coastal-900 via-ocean-900 to-coastal-900 text-white relative overflow-hidden">
        {/* Background Pattern */}

    ...
    <PageTransition>
      ...
      <section className="relative min-h-[calc(100vh-80px)] flex items-center overflow-hidden">
        ...
        <div className="fixed inset-0 z-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-br from-white/30 via-transparent to-ocean-900/10" />
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div>
              <motion.div
                ...
                className="inline-flex items-center gap-2 px-4 py-2 bg-white/90 backdrop-blur-sm text-ocean-600 rounded-full text-xs font-semibold mb-6 shadow-sm ring-1 ring-ocean-100"
              >
              ...
              <motion.h1
                ...
                className="text-4xl sm:text-5xl lg:text-6xl font-display font-bold text-coastal-900 leading-[1.1] mb-6"
              >
                Coastal Erosion{' '}
                <span className="gradient-text-accent">Threshold Detection</span>{' '}
                Framework
              </motion.h1>
              ...
              <motion.p
                ...
                className="text-lg text-coastal-600 mb-8 max-w-xl leading-relaxed"
              >
              ...
              <motion.div
                ...
                className="grid grid-cols-2 sm:grid-cols-4 gap-6 mt-12 pt-8 border-t border-coastal-200/50"
              >
                {stats.map((stat, index) => (
                  <div key={index} className="group">
                    <div className="text-2xl font-display font-bold text-coastal-900 group-hover:text-ocean-600 transition-colors">
                      {stat.value}
                    </div>
                    <div className="text-sm text-coastal-500 font-medium">{stat.label}</div>
                  </div>
                ))}
              </motion.div>
            </div>
            ...
            >
              <div className="relative w-full aspect-square">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="card-glass p-8 w-80">
                    <div className="flex items-center gap-4 mb-6">
                      <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-ocean-500 to-primary-600 flex items-center justify-center shadow-lg shadow-ocean-500/20">
                ...
                <motion.div
                  ...
                  className="absolute top-10 left-0 card-glass p-4"
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-xs text-coastal-500 font-medium">Model Accuracy</div>
                ...
                <motion.div
                  ...
                  className="absolute bottom-20 right-0 card-glass p-4"
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-xs text-coastal-500 font-medium">Mean NSM</div>
